...
func init() {
	...
	beego.GlobalControllerRouter["invenio/controllers:HotelController"] = append(beego.GlobalControllerRouter["invenio/controllers:HotelController"],
		beego.ControllerComments{
			"Post",
			`/`,
			[]string{"post"},
	...
	beego.GlobalControllerRouter["invenio/controllers:RestController"] = append(beego.GlobalControllerRouter["invenio/controllers:RestController"],
		beego.ControllerComments{
			"Post",
			`/`,
			[]string{"post"},
